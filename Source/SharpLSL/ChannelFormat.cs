...
{
    /// <summary>
    /// Specifies the data format of a channel.
    /// </summary>
    /// <remarks>
    /// This enumeration defines the format of data transmitted for each channel.
    ...
    {
        /// <summary>
        /// Represents a 32-bit single-precision floating-point format.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Represents a 32-bit integer format.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Represents a 16-bit integer format.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Represents an 8-bit integer format.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Represents a 64-bit integer format.
        /// </summary>
        /// <remarks>
        /// This format is used for transmitting data that requires 64-bit integer
        /// precision. Note that support for this type is not yet exposed in all
        /// languages. Also, some builds of liblsl will not be able to send or
