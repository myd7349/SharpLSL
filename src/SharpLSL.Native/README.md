...
[SharpLSL.Native.linux-musl-x64-nuget]: https://www.nuget.org/packages/SharpLSL.Native.linux-musl-x64
...
During the packaging process, liblsl binary archives are automatically downloaded from the [liblsl-ci-build](https://github.com/SharpLSL/liblsl-ci-build) release page and then packed into the corresponding NuGet packages named `SharpLSL.Native.[RID]`.
