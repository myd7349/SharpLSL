//------------------------------------------------------------------------------
// <auto-generated>
//     This file is generated by StreamInlet.tt.
//
...
namespace SharpLSL
{
    ...
    public class StreamInlet : LSLObject
    {
        ...
        public StreamInfo GetStreamInfo(double timeout = Forever)
        {
            ...
            unsafe
            {
                streamInfo = lsl_get_fullinfo(handle, timeout, &errorCode);
            }
        ...
        public void OpenStream(double timeout = Forever)
        {
            ...
            unsafe
            {
                lsl_open_stream(handle, timeout, &errorCode);
            }
        ...
        public double TimeCorrection(double timeout = Forever)
        {
            ...
            unsafe
            {
                result = lsl_time_correction(handle, timeout, &errorCode);
            }
        ...
        public double TimeCorrection(ref double remoteTime, ref double uncertainty, double timeout = Forever)
        {
            ...
            var remoteTimeOut = 0.0;
            var uncertaintyOut = 0.0;
            var errorCode = (int)lsl_error_code_t.lsl_no_error;
            double result;

            unsafe
            {
                result = lsl_time_correction_ex(handle, &remoteTimeOut, &uncertaintyOut, timeout, &errorCode);
            }

            CheckError(errorCode);

            remoteTime = remoteTimeOut;
        ...
        public double PullSample(sbyte[] sample, double timeout = Forever)
        {
            ...
            unsafe
            {
                ...
                {
                    timestamp = lsl_pull_sample_c(handle, buffer, sample.Length, timeout, &errorCode);
                }
            }
            ...
            return timestamp;
#else
            return PullSample(sample.AsSpan(), timeout);
#endif
        }
        ...
        public double PullSample(short[] sample, double timeout = Forever)
        {
            ...
            unsafe
            {
                ...
                {
                    timestamp = lsl_pull_sample_s(handle, buffer, sample.Length, timeout, &errorCode);
                }
            }
        ...
        public double PullSample(int[] sample, double timeout = Forever)
        {
            ...
            unsafe
            {
                ...
                {
                    timestamp = lsl_pull_sample_i(handle, buffer, sample.Length, timeout, &errorCode);
                }
            }
        ...
        public double PullSample(long[] sample, double timeout = Forever)
        {
            ...
            unsafe
            {
                ...
                {
                    timestamp = lsl_pull_sample_l(handle, buffer, sample.Length, timeout, &errorCode);
                }
            }
        ...
        public double PullSample(float[] sample, double timeout = Forever)
        {
            ...
            unsafe
            {
                ...
                {
                    timestamp = lsl_pull_sample_f(handle, buffer, sample.Length, timeout, &errorCode);
                }
            }
        ...
        public double PullSample(double[] sample, double timeout = Forever)
        {
            ...
            unsafe
            {
                ...
                {
                    timestamp = lsl_pull_sample_d(handle, buffer, sample.Length, timeout, &errorCode);
                }
            }
        ...
        public double PullSample(string[] sample, double timeout = Forever)
        {
            ...
            try
            {
                unsafe
                {
                    ...
                    timestamp = lsl_pull_sample_str(handle, buffer, buffer.Length, timeout, &errorCode);
                }
        ...
        public double PullSample(byte[][] sample, double timeout = Forever)
        {
            ...
            try
            {
                unsafe
                {
                    ...
                    timestamp = lsl_pull_sample_buf(handle, buffer, lengths, buffer.Length, timeout, &errorCode);
                }
        ...
        public double PullSample(byte[] sample, double timeout = Forever)
        {
            ...
            unsafe
            {
                ...
                {
                    timestamp = lsl_pull_sample_v(handle, buffer, sample.Length, timeout, &errorCode);
                }
            }
        ...
        public double PullSample(IntPtr sample, /*int length,*/ double timeout = Forever)
        {
            ...
            unsafe
            {
                timestamp = lsl_pull_sample_v(handle, sample, _sampleBytes, timeout, &errorCode);
            }
        ...
        public int PullChunk(sbyte[] chunk, double[] timestamps = null, double timeout = 0.0)
        {
            ...
            unsafe
            {
                ...
                fixed (double* timestampsBuffer = timestamps)
                {
                    result = lsl_pull_chunk_c(
                        ...
                        (uint)(timestamps?.Length ?? 0), timeout, &errorCode);
                }
            }
            ...
            return (int)result;
#else
            return PullChunk(chunk.AsSpan(), timestamps.AsSpan(), timeout);
#endif
        }

#if !NET35
        /// <inheritdoc cref="PullChunk(sbyte[], double[], double)"/>
        public int PullChunk(Span<sbyte> chunk, Span<double> timestamps, double timeout = 0.0)
        {
            ThrowIfInvalid();
...
#if !NET35
        /// <inheritdoc cref="PullChunk(sbyte[], double[], double)"/>
        public int PullChunk(Span<short> chunk, Span<double> timestamps, double timeout = 0.0)
        {
            ThrowIfInvalid();
...
#if !NET35
        /// <inheritdoc cref="PullChunk(sbyte[], double[], double)"/>
        public int PullChunk(Span<int> chunk, Span<double> timestamps, double timeout = 0.0)
        {
            ThrowIfInvalid();
...
#if !NET35
        /// <inheritdoc cref="PullChunk(sbyte[], double[], double)"/>
        public int PullChunk(Span<long> chunk, Span<double> timestamps, double timeout = 0.0)
        {
            ThrowIfInvalid();
...
#if !NET35
        /// <inheritdoc cref="PullChunk(sbyte[], double[], double)"/>
        public int PullChunk(Span<float> chunk, Span<double> timestamps, double timeout = 0.0)
        {
            ThrowIfInvalid();
...
#if !NET35
        /// <inheritdoc cref="PullChunk(sbyte[], double[], double)"/>
        public int PullChunk(Span<double> chunk, Span<double> timestamps, double timeout = 0.0)
        {
            ThrowIfInvalid();
...
#if !NET35
        /// <inheritdoc cref="PullChunk(sbyte[], double[], double)"/>
        public int PullChunk(Span<string> chunk, Span<double> timestamps, double timeout = 0.0)
        {
            ThrowIfInvalid();
...
// https://github.com/Cysharp/MessagePipe/blob/1.8.1/src/MessagePipe/MessagePipe.csproj
