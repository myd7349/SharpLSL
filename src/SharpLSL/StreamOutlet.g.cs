//------------------------------------------------------------------------------
// <auto-generated>
//     This file is generated by StreamOutlet.tt.
//
    ...
    public class StreamOutlet : LSLObject
    {
        ...
        public void PushSample(sbyte[] sample, double timestamp = 0.0, bool pushThrough = true)
        {
            ...
            unsafe
            {
                ...
                {
                    result = lsl_push_sample_ctp(handle, buffer, timestamp, pushThrough ? 1 : 0);
                }
            }

            CheckError(result);
#else
            PushSample(sample.AsSpan(), timestamp, pushThrough);
#endif
        }
        ...
        public void PushSample(short[] sample, double timestamp = 0.0, bool pushThrough = true)
        {
            ...
            unsafe
            {
                ...
                {
                    result = lsl_push_sample_stp(handle, buffer, timestamp, pushThrough ? 1 : 0);
                }
            }
        ...
        public void PushSample(int[] sample, double timestamp = 0.0, bool pushThrough = true)
        {
            ...
            unsafe
            {
                ...
                {
                    result = lsl_push_sample_itp(handle, buffer, timestamp, pushThrough ? 1 : 0);
                }
            }
        ...
        public void PushSample(long[] sample, double timestamp = 0.0, bool pushThrough = true)
        {
            ...
            unsafe
            {
                ...
                {
                    result = lsl_push_sample_ltp(handle, buffer, timestamp, pushThrough ? 1 : 0);
                }
            }
        ...
        public void PushSample(float[] sample, double timestamp = 0.0, bool pushThrough = true)
        {
            ...
            unsafe
            {
                ...
                {
                    result = lsl_push_sample_ftp(handle, buffer, timestamp, pushThrough ? 1 : 0);
                }
            }
        ...
        public void PushSample(double[] sample, double timestamp = 0.0, bool pushThrough = true)
        {
            ...
            unsafe
            {
                ...
                {
                    result = lsl_push_sample_dtp(handle, buffer, timestamp, pushThrough ? 1 : 0);
                }
            }
        ...
        public void PushSample(byte[] sample, double timestamp = 0.0, bool pushThrough = true)
        {
            ...
            unsafe
            {
                ...
                {
                    result = lsl_push_sample_vtp(handle, buffer, timestamp, pushThrough ? 1 : 0);
                }
            }
        ...
        public void PushChunk(sbyte[] chunk, double timestamp = 0.0, bool pushThrough = true)
        {
            ...
            unsafe
            {
                ...
                {
                    result = lsl_push_chunk_ctp(handle, buffer, (uint)chunk.Length, timestamp, pushThrough ? 1 : 0);
                }
            }

            CheckError(result);
#else
            PushChunk(chunk.AsSpan(), timestamp, pushThrough);
#endif
        }
        ...
        public void PushChunk(short[] chunk, double timestamp = 0.0, bool pushThrough = true)
        {
            ...
            unsafe
            {
                ...
                {
                    result = lsl_push_chunk_stp(handle, buffer, (uint)chunk.Length, timestamp, pushThrough ? 1 : 0);
                }
            }
        ...
        public void PushChunk(int[] chunk, double timestamp = 0.0, bool pushThrough = true)
        {
            ...
            unsafe
            {
                ...
                {
                    result = lsl_push_chunk_itp(handle, buffer, (uint)chunk.Length, timestamp, pushThrough ? 1 : 0);
                }
            }
        ...
        public void PushChunk(long[] chunk, double timestamp = 0.0, bool pushThrough = true)
        {
            ...
            unsafe
            {
                ...
                {
                    result = lsl_push_chunk_ltp(handle, buffer, (uint)chunk.Length, timestamp, pushThrough ? 1 : 0);
                }
            }
        ...
        public void PushChunk(float[] chunk, double timestamp = 0.0, bool pushThrough = true)
        {
            ...
            unsafe
            {
                ...
                {
                    result = lsl_push_chunk_ftp(handle, buffer, (uint)chunk.Length, timestamp, pushThrough ? 1 : 0);
                }
            }
        ...
        public void PushChunk(double[] chunk, double timestamp = 0.0, bool pushThrough = true)
        {
            ...
            unsafe
            {
                ...
                {
                    result = lsl_push_chunk_dtp(handle, buffer, (uint)chunk.Length, timestamp, pushThrough ? 1 : 0);
                }
            }
        ...
        public void PushChunk(sbyte[] chunk, double[] timestamps, bool pushThrough = true)
        {
            ...
            unsafe
            {
                ...
                {
                    result = lsl_push_chunk_ctnp(handle, chunkBuffer, (uint)chunk.Length, timestampsBuffer, pushThrough ? 1 : 0);
                }
            }

            CheckError(result);
#else
            PushChunk(chunk.AsSpan(), timestamps.AsSpan(), pushThrough);
#endif
        }
        ...
        public void PushChunk(short[] chunk, double[] timestamps, bool pushThrough = true)
        {
            ...
            unsafe
            {
                ...
                fixed (double* timestampsBuffer = timestamps)
                {
                    result = lsl_push_chunk_stnp(handle, chunkBuffer, (uint)chunk.Length, timestampsBuffer, pushThrough ? 1 : 0);
                }
            }
        ...
        public void PushChunk(int[] chunk, double[] timestamps, bool pushThrough = true)
        {
            ...
            unsafe
            {
                ...
                fixed (double* timestampsBuffer = timestamps)
                {
                    result = lsl_push_chunk_itnp(handle, chunkBuffer, (uint)chunk.Length, timestampsBuffer, pushThrough ? 1 : 0);
                }
            }
        ...
        public void PushChunk(long[] chunk, double[] timestamps, bool pushThrough = true)
        {
            ...
            unsafe
            {
                ...
                fixed (double* timestampsBuffer = timestamps)
                {
                    result = lsl_push_chunk_ltnp(handle, chunkBuffer, (uint)chunk.Length, timestampsBuffer, pushThrough ? 1 : 0);
                }
            }
        ...
        public void PushChunk(float[] chunk, double[] timestamps, bool pushThrough = true)
        {
            ...
            unsafe
            {
                ...
                fixed (double* timestampsBuffer = timestamps)
                {
                    result = lsl_push_chunk_ftnp(handle, chunkBuffer, (uint)chunk.Length, timestampsBuffer, pushThrough ? 1 : 0);
                }
            }
        ...
        public void PushChunk(double[] chunk, double[] timestamps, bool pushThrough = true)
        {
            ...
            unsafe
            {
                ...
                fixed (double* timestampsBuffer = timestamps)
                {
                    result = lsl_push_chunk_dtnp(handle, chunkBuffer, (uint)chunk.Length, timestampsBuffer, pushThrough ? 1 : 0);
                }
            }
