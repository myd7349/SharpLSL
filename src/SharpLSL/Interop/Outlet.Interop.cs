...
namespace SharpLSL.Interop
{
    public static unsafe partial class LSL
    {
        ...
        [DllImport("lsl", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern int lsl_push_sample_strt(
            lsl_outlet @out,
            [MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.LPStr)] string[] data,
            double timestamp);
        ...
        [DllImport("lsl", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern int lsl_push_chunk_str(
            lsl_outlet @out,
            [MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.LPStr)] string[] data,
            uint data_elements);
        ...
        [DllImport("lsl", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern int lsl_push_chunk_strt(
            lsl_outlet @out,
            [MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.LPStr)] string[] data,
            uint data_elements,
            double timestamp);
        ...
        [DllImport("lsl", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern int lsl_push_chunk_strtn(
            lsl_outlet @out,
            [MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.LPStr)] string[] data,
            uint data_elements,
            double[] timestamps);
